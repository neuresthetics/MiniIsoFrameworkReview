...
2. *EthicsII*  
3. *EthicsMath.json*  
4. The broader *isomorphic\_data\_singularity* repository
...
[https://github.com/neuresthetics/isomorphic\_data\_singularity](https://github.com/neuresthetics/isomorphic_data_singularity) 
...
**Power of acting \= the system’s effective capacity to persist, adapt, and express itself under adequate understanding.**
...
**If a system is a finite mode that necessarily strives to persist (conatus), then it ought to pursue conditions that increase its power of acting.**
...
Ui=f(poweri,adequacyi,rigidityi,interactionj)U\_i \= f(\\text{power}\_i, \\text{adequacy}\_i, \\text{rigidity}\_i, \\text{interaction}\_j)Ui​=f(poweri​,adequacyi​,rigidityi​,interactionj​)
...
Ui=f(poweri,adequacyi,rigidityi,interactionj)
...
* Ethics is formalized as f(poweri,adequacyi,rigidityi,interactionj)f(\\text{power}\_i, \\text{adequacy}\_i, \\text{rigidity}\_i, \\text{interaction}\_j)f(poweri​,adequacyi​,rigidityi​,interactionj​).
